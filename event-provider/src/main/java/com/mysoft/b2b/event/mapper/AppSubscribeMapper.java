...
public interface AppSubscribeMapper {
    
	public void insert(AppSubscribe app) ;
	
    public void update(AppSubscribe app) ;
    
    public void delete(String appId) ;
    
    public List<AppSubscribe> getAppSubscribeList(AppSubscribeCriteria criteria) ;
